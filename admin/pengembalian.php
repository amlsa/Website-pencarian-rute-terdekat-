...
$query="SELECT * FROM mobil join merk WHERE mobil.Status_mobil='kosong' and merk.id=mobil.merk";
...
?>
  ...
  <thead>
    <tr>
	  ...
	  <th scope="col">Konfirmasi Kembali</th>
    </tr>
  </thead>
  <tbody>
  <?php
$i=1; 
 while ($baris=mysqli_fetch_array($hasil)) { ?>
    <tr>
	  ...
	  <td><a href="proseskonfirmasi_kembali.php?id_mobil=<?php echo $baris['id']?>" <button type="button" class="btn btn-outline-danger">Sudah Kembali</button></a>
	  </td>
    </tr>
 <?php } ?>
  </tbody>
